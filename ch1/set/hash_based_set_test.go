...
func TestHashBasedSetAdd(t *testing.T) {
	type Want struct {
		members []int
		err error 
	}
...
func TestHashBasedSetEqual(t *testing.T) {
	tests := []struct {
		name    string
	...
	}{
		{
			...
			func() (Set[int], Set[int]) {
				set1 := NewHashBasedSet[int]()
				set2 := NewHashBasedSet[int]()
				return set1, set2
			},
			true,
		},
...
func TestHashBasedSetIntersect(t *testing.T) {
	tests := []struct {
		name    string
		initSets func() (Set[int], Set[int])
		want    []int
...
func TestHashBasedSetIsNull(t *testing.T) {
	tests := []struct {
		name    string
		initSet func() Set[int]
		want    bool
...
func TestHashBasedSetIsSubsetOf(t *testing.T) {
	tests := []struct {
		name    string
		initSets func() (Set[int], Set[int])
		want    bool
...
func TestHashBasedSetMembers(t *testing.T) {
	tests := []struct {
		name    string
		initSet func() Set[int]
		want    []int
...
func TestHashBasedSetRemove(t *testing.T) {
	tests := []struct {
		name    string
		initSet func() Set[int]
		remove int
...
func TestHashBasedSetSearch(t *testing.T) {
	tests := []struct {
		name    string
		initSet func() Set[int]
		search int
...
func TestHashBasedSetSize(t *testing.T) {
	tests := []struct {
		name    string
		initSet func() Set[int]
		want    int
...
func TestHashBasedSetUnion(t *testing.T) {
	tests := []struct {
		name    string
		initSets func() (Set[int], Set[int])
		want    []int
